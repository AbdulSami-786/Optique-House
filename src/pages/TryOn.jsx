...
export const GLASS_OPTIONS = [
  { id:"/glass1.png",  name:"T04917 - Square Plastic Sunglass Luxury Style", price:"PKR 2,999", sizes:[{label:"XL",scale:1.10,mobileScale:1.00}] },
  { id:"/glass2.png",  name:"K01 - Oval Plastic Sunglass",                   price:"PKR 800",   sizes:[{label:"L", scale:1.15,mobileScale:1.00}] },
  { id:"/glass3.png",  name:"D403054S - Square Plastic Sunglass",            price:"PKR 2,400", sizes:[{label:"L", scale:1.15,mobileScale:1.00}] },
  { id:"/glass4.png",  name:"20237 - Square Shape Plastic Sunglass",         price:"PKR 800",   sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass5.png",  name:"RB4455F - Square Plastic Sunglass",             price:"PKR 2,500", sizes:[{label:"L", scale:1.25,mobileScale:0.98}] },
  { id:"/glass6.png",  name:"5013 - Square Plastic Shape Sunglass",          price:"PKR 2,400", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass7.png",  name:"S2160 - Square Plastic Sunglass",               price:"PKR 1,899", sizes:[{label:"XL",scale:1.30,mobileScale:1.10}] },
  { id:"/glass8.png",  name:"3377 - Plastic Eye Sunglass",                   price:"PKR 1,600", sizes:[{label:"XL",scale:1.30,mobileScale:1.10}] },
  { id:"/glass9.png",  name:"28044 - Square Plastic Sunglass",               price:"PKR 2,899", sizes:[{label:"M", scale:1.00,mobileScale:0.75}] },
  { id:"/glass10.png", name:"99032 - Eye Plastic Sunglass",                  price:"PKR 4,200", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass11.png", name:"T1798 - Square Plastic Sunglass",               price:"PKR 2,400", sizes:[{label:"S", scale:0.75,mobileScale:0.50}] },
  { id:"/glass12.png", name:"28118 - Eye Plastic Sunglass",                  price:"PKR 3,200", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass13.png", name:"IPB - One Piece Sunglass",                      price:"PKR 800",   sizes:[{label:"M", scale:1.00,mobileScale:0.75}] },
  { id:"/glass14.png", name:"F0493 - Plastic Square Men Sunglass",           price:"PKR 4,600", sizes:[{label:"S", scale:0.95,mobileScale:0.50}] },
  { id:"/glass15.png", name:"BL0985 - Square Plastic Sunglass",              price:"PKR 3,200", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass16.png", name:"D7481 - Box Plastic Sunglass",                  price:"PKR 4,800", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass17.png", name:"H077048 - Box Plastic Sunglass",                price:"PKR 4,600", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass18.png", name:"9702 - Metal Oval",                             price:"PKR 1,499", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass19.png", name:"JV5816 - Plastic Curve Square Shape",           price:"PKR 1,399", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass20.png", name:"D8822 - Plastic Square Shape",                  price:"PKR 1,199", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass21.png", name:"PS8035 - Plastic Square Shape",                 price:"PKR 1,399", sizes:[{label:"M", scale:1.00,mobileScale:0.75}] },
  { id:"/glass22.png", name:"D8815 - Plastic Vaffer Shape",                  price:"PKR 1,499", sizes:[{label:"L", scale:1.05,mobileScale:0.95}] },
  { id:"/glass23.png", name:"9362 - Plastic Square Shape",                   price:"PKR 1,199", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass24.png", name:"D8953 - Plastic Square Shape",                  price:"PKR 1,499", sizes:[{label:"S", scale:0.85,mobileScale:0.50}] },
  { id:"/glass25.png", name:"TR1020 - Plastic Eye Shape",                    price:"PKR 1,199", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass26.png", name:"BV6522 - Plastic Eye Shape",                    price:"PKR 1,799", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass27.png", name:"D9108 - Plastic Square Shape",                  price:"PKR 1,199", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass28.png", name:"9368 - Plastic Square Shape",                   price:"PKR 1,499", sizes:[{label:"M", scale:1.00,mobileScale:0.75}] },
  { id:"/glass29.png", name:"K88212 - Metal Eye Shape",                      price:"PKR 1,899", sizes:[{label:"L", scale:1.25,mobileScale:0.95}] },
  { id:"/glass30.png", name:"B7195 - Plastic Eye Shape",                     price:"PKR 1,999", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass31.png", name:"D1256 - Plastic Oval Shape",                    price:"PKR 1,499", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass32.png", name:"P3002 - Plastic Square Shape",                  price:"PKR 1,499", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass33.png", name:"2011 - Plastic Oval Shape",                     price:"PKR 1,499", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass34.png", name:"AR2005 - Plastic Oval Shape",                   price:"PKR 2,299", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass35.png", name:"P210 - Plastic Square Shape",                   price:"PKR 1,499", sizes:[{label:"M", scale:1.10,mobileScale:0.75}] },
  { id:"/glass36.png", name:"D8954 - Plastic Round Shape",                   price:"PKR 1,799", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass37.png", name:"K58083 - Plastic & Metal Round shape",          price:"PKR 2,899", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass38.png", name:"LFL228 - Plastic & Metal Round Shape",          price:"PKR 1,999", sizes:[{label:"XL",scale:1.30,mobileScale:1.10}] },
  { id:"/glass39.png", name:"OF8651 - Plastic & Metal Round Shape",          price:"PKR 1,999", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass40.png", name:"OF8506 - Plastic & Metal Round Shape",          price:"PKR 2,899", sizes:[{label:"M", scale:1.00,mobileScale:0.75}] },
  { id:"/glass41.png", name:"1122 - Plastic & Metal Round Shape",            price:"PKR 2,299", sizes:[{label:"L", scale:1.15,mobileScale:0.95}] },
  { id:"/glass42.png", name:"R1013 - RimLess Eye Shape",                     price:"PKR 1,999", sizes:[{label:"S", scale:0.95,mobileScale:0.50}] },
];
...
function extractFaceGeometry(lm, W, H, useIris=true) {
  ...
  const avgPx= is => { const ps=is.map(px); return { x:ps.reduce((s,p)=>s+p.x,0)/ps.length, y:ps.reduce((s,p)=>s+p.y,0)/ps.length }; };
  const dist = (a,b) => Math.hypot(a.x-b.x, a.y-b.y);

  const leo=px(LM.LEFT_EYE_OUTER), reo=px(LM.RIGHT_EYE_OUTER);
  const lei=px(LM.LEFT_EYE_INNER), rei=px(LM.RIGHT_EYE_INNER);
  const nbt=px(LM.NOSE_BRIDGE_TOP);
  const lb=avgPx(LM.LEFT_EYEBROW_LOWER), rb=avgPx(LM.RIGHT_EYEBROW_LOWER);

  let li, ri;
  if (useIris && lm.length>473) { li=px(LM.LEFT_IRIS_CENTER); ri=px(LM.RIGHT_IRIS_CENTER); }
  else { li={x:(leo.x+lei.x)/2,y:(leo.y+lei.y)/2}; ri={x:(reo.x+rei.x)/2,y:(reo.y+rei.y)/2}; }

  const irisY=( li.y+ri.y)/2, centerX=(li.x+ri.x)/2;
  const browMidY=(lb.y+rb.y)/2;
  const centerY=irisY*.65+nbt.y*.30+browMidY*.05;
...
const Section = ({ title, icon, defaultOpen=false, children }) => {
  ...
  return (
    <div style={{ borderRadius:16, border:`1px solid ${C.glassBorder}`, overflow:"hidden",
      ...
      {open && <div style={{ padding:16, background:"rgba(245,243,199,0.40)" }}>{children}</div>}
    </div>
  );
};
...
const TryOn = () => {
  ...
  // Resolve initial frame from route state (once)
  ...
  useEffect(() => {
    const onResize = () => {
      ...
      if (m && videoRef.current?.videoWidth) {
        ...
        canvasRef.current.width=DESKTOP_CAM_W; canvasRef.current.height=DESKTOP_CAM_H; ctxRef.current=null;
      }
    };
  ...
  const drawLoop = useCallback(() => {
    ...
    ctx.filter = needsFilter ? `brightness(${BEAUTY_B}%) contrast(${BEAUTY_C}%) saturate(${BEAUTY_S}%) brightness(${uB}%) contrast(${uC}%) saturate(${uS}%)` : "none";
    ...
    const sm  = smootherRef.current.smooth(
      { cx:mcx, cy:geo.centerY, gw:geo.glassesWidth, gh:geo.glassesHeight, angle:geo.angle, ds:geo.depthScale },
      mobile ? 1.0 : 0,
    );
    ...
    w = Math.max(20, Math.min(W*.95, w));
    h = Math.max(8,  Math.min(H*.60, h));

    const mAngle = -sm.angle;
    const halfW=w*.5, halfH=h*.5;
  ...
  useEffect(() => {
    ...
    faceMesh.setOptions({
      ...
      minDetectionConfidence:mobile?.40:.50,
      minTrackingConfidence: mobile?.35:.50,
    });
      ...
      video.onloadedmetadata = () => {
        video.play().then(() => {
          ...
          if (mobile) {
            ...
            if (canvasRef.current) { canvasRef.current.width=DESKTOP_CAM_W; canvasRef.current.height=DESKTOP_CAM_H; ctxRef.current=null; }
          }
  ...
  if (isMobile) {
    ...
    return (
      <>
        <style>{css}</style>
        <div style={{ display:"flex", flexDirection:"column", height:"100dvh", background:"#000", touchAction:"pan-y" }}
          ...
          <div style={{ position:"relative", flex:"1 1 auto", minHeight:0, background:"#000", overflow:"hidden" }}>
            ...
            <canvas ref={canvasRef} style={{ position:"absolute", inset:0, width:"100%", height:"100%", objectFit:"contain", display:"block" }} aria-label="AR glasses try-on" />
            ...
            {cameraReady && (
              <div style={{ position:"absolute", top:12, right:12, zIndex:20, display:"flex", alignItems:"center",
                background:"rgba(0,0,0,0.55)", ...glassPill, border:"1px solid rgba(115,165,202,.30)", padding:"5px 12px" }}>
                <span className="ar-dot" />
                <span style={{ fontSize:10, fontWeight:600, color:"rgba(255,255,255,.80)", letterSpacing:".5px" }}>Tracking</span>
              </div>
            )}
            ...
            {cameraReady && currentGlass && (
              <div aria-live="polite" style={{ position:"absolute", bottom:16, left:"50%", transform:"translateX(-50%)",
                ...
                <span style={{ fontSize:12, fontWeight:700, background:"linear-gradient(135deg,#F5A623,#E87F24)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>{currentGlass.price}</span>
              </div>
            )}

            {/* Progress dots */}
            {cameraReady && (
              <div style={{ position:"absolute", bottom:56, left:"50%", transform:"translateX(-50%)", display:"flex", gap:4, zIndex:20 }}>
                {GLASS_OPTIONS.map((g,i) => (
                  <div key={g.id} style={{ width:i===idx?14:4, height:4, borderRadius:3,
                    background:i===idx?"#E87F24":"rgba(255,255,255,.25)", transition:"all .25s ease" }} />
                ))}
              </div>
            )}
              ...
              <div role="status" style={{ position:"absolute", inset:0, zIndex:50,
                ...
                <div style={{ textAlign:"center" }}>
                  <div style={{ fontFamily:"'Outfit',sans-serif", fontSize:22, fontWeight:800, marginBottom:6,
                    background:"linear-gradient(135deg,#F5A623,#E87F24)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>VR.OPTICS</div>
                ...
                <div style={{ fontSize:9, color:"rgba(254,253,223,.22)", border:"0.5px solid rgba(255,255,255,.10)", borderRadius:100, padding:"4px 14px" }}>← Swipe to browse frames →</div>
              </div>
            )}
          </div>
          ...
          <div style={{ flexShrink:0, paddingBottom:"env(safe-area-inset-bottom,10px)",
            ...
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"8px 20px 2px" }}>
              <span style={{ fontSize:9, fontWeight:700, letterSpacing:"2px", color:"rgba(254,253,223,.35)", textTransform:"uppercase" }}>Frames</span>
                ...
                return (
                  <div key={g.id} ref={isA?activeCarouselRef:null}
                    ...
                    <div className="lens-ring__circle" style={{ width:sz, height:sz,
                      background:isA?"radial-gradient(circle at 35% 35%,rgba(232,127,36,.28),rgba(10,5,2,.95))"
          ...
          <div style={{ flex:1, position:"relative", borderRadius:22, overflow:"hidden",
            ...
            {incomingProductName && cameraReady && (
              <div style={{ position:"absolute", bottom:60, left:"50%", transform:"translateX(-50%)",
                ...
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#E87F24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7S2 12 2 12z"/></svg>
                <span style={{ fontSize:11, fontWeight:700, color:"rgba(254,253,223,.90)", letterSpacing:".5px" }}>Viewing: {incomingProductName}</span>
              </div>
            )}

            {cameraReady && (
              <div role="status" style={{ position:"absolute", top:16, right:16, zIndex:5, display:"flex", alignItems:"center",
                background:"rgba(0,0,0,.42)", ...glassPill, border:"1px solid rgba(115,165,202,.28)", padding:"5px 14px", animation:"fadeIn .3s ease" }}>
                <span className="ar-dot" />
                <span style={{ fontSize:10, fontWeight:600, color:"rgba(255,255,255,.80)", letterSpacing:".5px" }}>Face Tracking Active</span>
              </div>
            )}
            ...
            <video ref={videoRef} style={{ position:"absolute", left:"-100%", top:"-100%", width:"1px", height:"1px", opacity:0, pointerEvents:"none" }} autoPlay playsInline muted />
            <canvas ref={canvasRef} width={DESKTOP_CAM_W} height={DESKTOP_CAM_H}
              ...
              <div role="status" style={{ position:"absolute", inset:0, borderRadius:22, zIndex:30,
                ...
                <div style={{ textAlign:"center" }}>
                  <div style={{ fontFamily:"'Outfit',sans-serif", fontSize:11, fontWeight:700, letterSpacing:"3px",
                    background:C.gradPrimary, WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", marginBottom:8 }}>INITIALIZING CAMERA</div>
          ...
          <div style={{ padding:"4px 4px 2px" }}>
            ...
            {incomingProductName && (
              <div style={{ marginTop:8, display:"flex", alignItems:"center", gap:6, padding:"5px 10px",
                ...
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke={C.primary} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7S2 12 2 12z"/></svg>
                <span style={{ fontSize:9, fontWeight:700, color:C.primary, letterSpacing:".5px" }}>From: {incomingProductName}</span>
              </div>
            )}
          </div>
              ...
              return (
                <div key={g.id} ref={isA?activeGridRef:null}
                  ...
                  <div style={{ fontSize:8, fontWeight:700,
                    ...
                    WebkitTextFillColor:isA?"transparent":C.primary, color:isA?"transparent":C.primary }}>{g.price}</div>
                </div>
              );
            })}
          </div>
