...
export default function About() {
  ...
  return (
    <div style={{ fontFamily: "Georgia,serif", background: "#FAFAF8", color: "#2C2C2C", minHeight: "100vh", overflowX: "hidden" }}>
      {/* ── HERO ── */}
      <section style={{ background: "#F5F3EF", padding: "48px 20px 64px 20px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48, alignItems: "center" }}>
            <FadeUp>
              <div>
                ...
                <a href="#story" style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "12px 28px", background: grad, color: "#fff", fontFamily: "Arial,sans-serif", fontSize: 14, fontWeight: 600, letterSpacing: "0.04em", border: "none", borderRadius: 50, cursor: "pointer", boxShadow: `0 8px 24px ${PURPLE}30`, textDecoration: "none" }}>
      ...
      {/* ── STORY ── */}
      <section id="story" style={{ maxWidth: 1200, margin: "0 auto", padding: "64px 20px 72px 20px" }}>
      ...
      {/* ── MISSION ── */}
      <div style={{ background: "#1C1C1C", padding: "64px 24px", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <FadeUp>
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ fontFamily: "Georgia,serif", fontSize: "clamp(22px, 4vw, 38px)", fontStyle: "italic", fontWeight: 400, lineHeight: 1.45, color: "#fff", maxWidth: 800, margin: "0 auto" }}>
              To deliver{" "}
      ...
      {/* ── VALUES ── */}
      <section style={{ background: "#F5F3EF", padding: "72px 20px" }}>
            ...
            {values.map((v, i) => (
              <FadeUp key={v.label} delay={i * 0.07}>
                ...
                >
                  ...
                  <p style={{ fontFamily: "Arial,sans-serif", fontSize: 13, lineHeight: 1.65, color: "#5A5A5A", fontWeight: 300 }}>{v.text}</p>
                </div>
              </FadeUp>
            ))}
          </div>
            ...
            <FadeUp key={m.name} delay={i * 0.1}>
              ...
              >
                ...
                <div style={{ padding: "24px 20px" }}>
                  <div style={{ fontFamily: "Georgia,serif", fontSize: 20, fontWeight: 700, color: "#1C1C1C", marginBottom: 4 }}>{m.name}</div>
                  ...
                  <p style={{ fontFamily: "Arial,sans-serif", fontSize: 13, lineHeight: 1.65, color: "#5A5A5A", fontWeight: 300 }}>{m.desc}</p>
                </div>
              </div>
            </FadeUp>
          ))}
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: "#F5F3EF", borderTop: "1px solid #E8E4DE", padding: "28px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 8, height: 8, borderRadius: "50%", background: grad, flexShrink: 0 }} />
          <span style={{ fontFamily: "Arial,sans-serif", fontSize: 11, color: "#9A9A9A" }}>© 2024 Optique House. All rights reserved.</span>
        </div>
        <div style={{ fontFamily: "Georgia,serif", fontStyle: "italic", fontSize: 14, color: "#5A5A5A" }}>Vision is Life</div>
      </footer>
    </div>
  );
}