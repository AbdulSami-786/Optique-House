...
const Home = () => {
  ...
  useEffect(() => {
    // Page title
    document.title = 'Eyewear Store Pakistan | Sunglasses, Eyeglasses & Contact Lenses';
    ...
    // Core SEO tags
    setMeta('description',
      'Shop premium sunglasses, eyeglasses, and contact lenses in Pakistan. ' +
      'Men, women & kids frames with virtual try-on. Nationwide delivery.'
    );
    setMeta('keywords',
      'sunglasses pakistan, eyeglasses pakistan, contact lenses pakistan, ' +
      'men sunglasses, women sunglasses, kids sunglasses, optical frames, ' +
      'prescription glasses online, blue light glasses, chashma, عینک, ' +
      'karachi eyewear, lahore glasses, islamabad optical, ' +
      'buy glasses online pakistan, virtual try-on glasses, ' +
      'cheap sunglasses pakistan, branded glasses pakistan, ' +
      'men eyeglass frames, women eyeglass frames, kids eyeglasses, ' +
      'daily contact lenses, monthly contact lenses, colored contact lenses'
    );
    setMeta('robots', 'index, follow');
    setMeta('author', 'Eyewear Store Pakistan');

    // Open Graph — WhatsApp / Facebook link previews
    setMeta('og:title',       'Eyewear Store Pakistan | Sunglasses, Eyeglasses & Contact Lenses', true);
    setMeta('og:description', 'Premium frames for men, women & kids. Virtual try-on. Nationwide delivery.', true);
    setMeta('og:type',        'website', true);
    setMeta('og:locale',      'en_PK', true);

    // Twitter card
    setMeta('twitter:card',        'summary_large_image');
    setMeta('twitter:title',       'Eyewear Store Pakistan | Sunglasses, Eyeglasses & Contact Lenses');
    setMeta('twitter:description', 'Premium frames for men, women & kids. Virtual try-on. Nationwide delivery.');

    // Restore title on unmount
    return () => {
      document.title = 'Eyewear Store';
    };
  }, []);
