...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="w-full max-w-sm bg-white p-4 font-sans relative">
      {/* Badges */}
        ...
        {product.variants.map((variant, index) => (
          <div key={index} className="relative group">
            ...
            {hoveredColor === variant.colorName && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-700 text-white text-[10px] rounded whitespace-nowrap z-20">
                {variant.colorName}
