      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-lg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-black tracking-tighter cursor-pointer">
            LUMINA <span className="text-blue-600">OPTICS</span>
          </div>

          {/* Desktop Menu */}
          <ul className="hidden lg:flex gap-8 font-semibold text-sm uppercase tracking-wider">
            <li className="hover:text-blue-600 cursor-pointer transition-colors">Prescription</li>
            <li className="hover:text-blue-600 cursor-pointer transition-colors">Sunglasses</li>
            <li className="hover:text-blue-600 cursor-pointer transition-colors">Contact Lenses</li>
            <li className="hover:text-blue-600 cursor-pointer transition-colors">Brands</li>
          </ul>
